...
import dev.tarjanyicsanad.fluentio.android.quizzes.data.entities.FreeTextAnswerEntity
...
@Database(
    entities = [QuizEntity::class, QuestionEntity::class, AnswerOptionEntity::class, FreeTextAnswerEntity::class],
    version = 1,
    exportSchema = true
)
